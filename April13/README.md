...
## Discoveries
This discovery has nothing to do with the production assignment but I finally learned how to make a split screen video! Since I am interacting with components in my circuit to create some kind of output on my laptop screen, the split screen helps connect what's going on off-screen with the stuff on-screen.
